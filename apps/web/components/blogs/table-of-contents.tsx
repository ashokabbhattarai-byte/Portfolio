...
export function TableOfContents({ headings }: { headings: TocItem[] }) {
  ...
  return (
    <nav ref={ref} aria-label="On this page" className="toc-nav">
      <style>{`.toc-label{font-size:12px !important;letter-spacing:0.16em !important;font-weight:600 !important;color:#527747 !important;display:flex;align-items:center;gap:10px;}
.toc-label::before{content:'';width:28px;height:2px;border-radius:999px;background:linear-gradient(90deg, #527747, #c7dca8);display:inline-block;}
...
.article-sidebar .toc-link:hover{color:#527747;border-left-color:#a8bf82;background:linear-gradient(90deg, rgba(199,220,168,0.14), transparent);}
.article-sidebar .toc-link[aria-current='true']{color:#527747;border-left-color:#527747;background:linear-gradient(90deg, rgba(199,220,168,0.18), transparent);}
...
.article-sidebar .toc-link{min-height:44px;border:1px solid rgba(82,119,71,0.25);border-left:1px solid rgba(82,119,71,0.25);border-radius:999px;padding:8px 16px;white-space:nowrap;font-size:14px;color:#527747;background:rgba(199,220,168,0.12);}
.article-sidebar .toc-link[aria-current='true']{background:#527747;color:#f4f3ee;border-color:#527747;}
}`}</style>
